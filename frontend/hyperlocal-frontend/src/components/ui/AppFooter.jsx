export default function AppFooter() {
  return (
    <footer className="w-full border-t border-gray-200 bg-white py-5 px-4 sm:px-6 lg:px-8 mt-auto">
      <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
        {/* Brand */}
        <div className="flex items-center gap-2">
          <div className="w-6 h-6 bg-primary rounded flex items-center justify-center shrink-0">
            <svg className="size-3.5 text-white" fill="none" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
          ...
          <span className="text-sm font-semibold text-charcoal">ShareMore</span>
        </div>
