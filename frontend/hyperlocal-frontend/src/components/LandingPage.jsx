...
// import { Link } from 'react-router-dom'; // ← Make sure this is EXACTLY like this
// import "../index.css";
...
//           <div className="flex items-center gap-3">
//             <button className="px-5 py-2.5 bg-primary text-white text-sm font-bold rounded-lg hover:brightness-110 transition-all">
//               Join Now
//             </button>
//             <button className="hidden sm:block px-5 py-2.5 bg-[#eaf0ef] dark:bg-[#3a4a4a] text-[#111816] dark:text-white text-sm font-bold rounded-lg hover:brightness-95 transition-all">
//               Login
//             </button>
//           </div>
//         </div>
